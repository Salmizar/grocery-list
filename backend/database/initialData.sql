...
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'Fruits & Vegtables', 1) RETURNING category_id INTO new_category_fruit_id;
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'Meats', 2) RETURNING category_id INTO new_category_meat_id;
...
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'Bread & Bakery', 5);
...
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'MISC', 11);
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'Prescription', 12);
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'Beverages', 13);
INSERT INTO categories (account_id, name, order_id) VALUES (new_account_id, 'Pet Supplies', 14);
...
INSERT INTO  items (account_id, category_id, store_ids, name) VALUES (new_account_id, new_category_fruit_id, new_store_yigs_id, 'Bag Salad');
INSERT INTO  items (account_id, category_id, store_ids, name) VALUES (new_account_id, new_category_fruit_id, new_store_yigs_id, 'Head of Lettuce');
...
INSERT INTO  items (account_id, category_id, store_ids, name) VALUES (new_account_id, new_category_dairy_id, new_store_yigs_id, 'Lactose free Milk') RETURNING item_id INTO new_item_6;
INSERT INTO  items (account_id, category_id, store_ids, name) VALUES (new_account_id, new_category_dairy_id, new_store_yigs_id, '1% Milk') RETURNING item_id INTO new_item_7;
...
INSERT INTO  items (account_id, category_id, store_ids, name) VALUES (new_account_id, new_category_dairy_id, new_store_yigs_id, '1% Lactose free Milk');
