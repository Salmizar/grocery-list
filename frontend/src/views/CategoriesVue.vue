<template>
  <div>
    ...
    <w-button xl bg-color="light-blue-light5" @click="addItem()" class="fill-width">{{ 'Add a Category' }}</w-button>
    <main>
      <ol>
        <MiscItem v-for="(item, index) in items" type="categories" :name="item.name" :index="index" :key="index" />
      </ol>
