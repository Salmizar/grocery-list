  ...
  <div class="reset-password-container">
    ...
    <div class="reset-password-form sh3">
      <w-form v-model="valid">
        ...
        <w-button class="ma1" xl bg-color="success" type="submit" :loading="submitloading" v-on:click="submitLoading()">{{(this.$route.query.new==='true')?'Set':'Update'}} Password</w-button>
      </w-form>
      <nav>
